    ...
    void initUniversity() {
        if (universityRepository.count() == 0) {
            ...
            List<University> universities = List.of(
                    ...
                    build("Beltei International University", "សាកលវិទ្យាល័យអន្តរជាតិបែលតៃ", "BELTEI"),
                    ...
                    build("Chea Sim University", "សាកលវិទ្យាល័យចៀស៊ីម", "CSU"),
                    ...
                    build("Phnom Penh International University", "សាកលវិទ្យាល័យអន្តរជាតិភ្នំពេញ", "PPIU"),
