...
public class KeycloakSecurity {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(endpoint -> endpoint
                ...
                .requestMatchers("/api/v1/users/me").hasAnyRole("ADMIN","INSTRUCTOR1","INSTRUCTOR2","SCHOLAR")
                ...
                .requestMatchers(HttpMethod.PATCH,"/api/v1/scholars/**").hasAnyRole("ADMIN","INSTRUCTOR1","SCHOLAR")
                ...
                .requestMatchers(HttpMethod.GET,"/api/v1/scholar-badges/**").permitAll()
                // Creating scholar badges requires any instructor or admin role
                .requestMatchers(HttpMethod.POST,"/api/v1/scholar-badges/**").hasAnyRole("ADMIN","INSTRUCTOR1","INSTRUCTOR2")
                // Partially updating scholar badges requires ADMIN or INSTRUCTOR1
                .requestMatchers(HttpMethod.PATCH,"/api/v1/scholar-badges/**").hasAnyRole("ADMIN","INSTRUCTOR1")
                // Deleting scholar badges requires ADMIN only
                .requestMatchers(HttpMethod.DELETE,"/api/v1/scholar-badges/**").hasAnyRole("ADMIN")
                ...
                .requestMatchers("/api/v1/scholars/me").hasAnyRole("SCHOLAR","ADMIN","INSTRUCTOR1","INSTRUCTOR2")
