...
//                 User and create into our db and keycloak
                ...
                .requestMatchers(HttpMethod.DELETE,"/api/v1/opening-programs/**").hasAnyRole("ADMIN")
                        .requestMatchers("/api/v1/opening-programs/**").permitAll()
                // Class
                ...
                .requestMatchers("/api/v1/scholars-achievements/**").permitAll()
                // Scholar Class
                ...
                .requestMatchers("/api/v1/scholar-classes/**").permitAll()
                // Certificate
